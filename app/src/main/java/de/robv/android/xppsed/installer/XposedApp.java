...
import de.robv.android.xppsed.installer.util.AssetUtil;
import de.robv.android.xppsed.installer.util.DownloadsUtil;
import de.robv.android.xppsed.installer.util.InstallZipUtil;
import de.robv.android.xppsed.installer.util.InstallZipUtil.XposedProp;
import de.robv.android.xppsed.installer.util.NotificationUtil;
...
public class XposedApp extends Application implements ActivityLifecycleCallbacks {
    ...
    private static final String BASE_DIR_LEGACY = "/data/data/de.robv.android.xppsed.installer/";

    public static final String BASE_DIR = Build.VERSION.SDK_INT >= 24
            ? "/data/user_de/0/de.robv.android.xppsed.installer/" : BASE_DIR_LEGACY;
    ...
    public static void installApk(Context context, DownloadsUtil.DownloadInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context, "de.robv.android.xppsed.installer.fileprovider", new File(info.localFilename));
