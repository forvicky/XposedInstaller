...
import de.robv.android.xppsed.installer.util.InstallZipUtil.ZipCheckResult;
import de.robv.android.xppsed.installer.util.RootUtil;

import static de.robv.android.xppsed.installer.util.InstallZipUtil.closeSilently;
import static de.robv.android.xppsed.installer.util.InstallZipUtil.triggerError;
import static de.robv.android.xppsed.installer.util.RootUtil.getShellPath;
